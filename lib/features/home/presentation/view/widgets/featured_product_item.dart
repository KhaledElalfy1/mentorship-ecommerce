...
class FeaturedProductItem extends StatelessWidget {
  const FeaturedProductItem({super.key, required this.image, required this.title, required this.price});
  final String image;
  final String title;
  final double price;
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        ...
        Text('\$ $price', style: Styles.textStyle16.copyWith(color: AppColor.gunmetalGray)),
      ],
    );
  }
}
